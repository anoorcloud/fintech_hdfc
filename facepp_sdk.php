...
class Facepp
{
    ...
    public $api_key         = 'sic4XfQ8dEkPbPDIPzLPb94hTBfpvhvz';        // set your API KEY or set the key static in the property
    public $api_secret      = 'Kk6ajXWxyTAreR3VhfCdoKQXCMPpVhh1';        // set your API SECRET or set the secret static in the property
